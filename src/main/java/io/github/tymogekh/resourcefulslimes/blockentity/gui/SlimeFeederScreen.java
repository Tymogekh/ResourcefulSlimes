...
public class SlimeFeederScreen extends AbstractContainerScreen<SlimeFeederMenu> implements MenuAccess<SlimeFeederMenu> {
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.blitSprite(RenderType::guiTextured, ResourceLocation.fromNamespaceAndPath(ResourcefulSlimes.MOD_ID, "container/slime_feeder/nutrition"), 18, 51, 0, 0, this.leftPos + 97, this.topPos + 64 - scaled, 18, scaled);
